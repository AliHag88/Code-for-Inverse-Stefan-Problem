function [au_xx_S, u_x_S, u_S, u_T, u, J] = Functional(xmesh, tmesh, svals, avals, g, u_true_0, s_star, w_meas, mu_meas)
  % Functional: Calculate functional and solution of forward problems
  % Input Arguments:
  %    - xmesh
  %    - tmesh
  %    - svals
