function [max_step_size, L_s, L_a, u_true_0, mu_meas, w_meas, g, s_star, s_ini, a_ini] = initial_setup(tmesh, xmesh, use_synthetic_data, initial_data_parameter)
...
% Preconditioning parameters for s and a, respectively
L_s = 0.01;
