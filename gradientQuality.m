function [estimate_s_precond, estimate_s, estimate_a_precond, estimate_a] = ...
  ...
  % Flag for use of synthetic data
  ...
  s_update_1 = grad_s(tmesh, s_old, w_meas, u_T, mu_meas, u_x_S, psi_x_S, psi_t_S, psi_S, u_S, au_xx_S, s_star);

  a_update_1 = grad_a(u,psi,tmesh,xmesh,s_old);

  % Preconditioning for s(t) gradient
  s_update_2 = precond(tmesh, regularization_s, s_update_1);

  % Preconditioning for a(t) gradient
  a_update_2 = precond(tmesh, regularization_a, a_update_1);
